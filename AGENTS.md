...
- Use `repair-context` only for high-confidence browser title/URL mismatch or missing-context repairs with neighbor/exact-URL evidence, or to convert all-missing and short unrecoverable mixed-context browser rows to untracked time.
