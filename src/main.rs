...
use activity_tracker::{
    ...
    UNREPAIRABLE_BROWSER_MISMATCH_UNTRACKED_SECONDS,
    UNREPAIRABLE_BROWSER_MISSING_TITLE_UNTRACKED_SECONDS, UsageSession, audit_sessions,
    ...
    if args.json {
        let value = serde_json::json!({
            ...
            "defaults": {
                ...
                "unrepairable_browser_mismatch_untracked_seconds": UNREPAIRABLE_BROWSER_MISMATCH_UNTRACKED_SECONDS,
                "unrepairable_browser_missing_title_untracked_seconds": UNREPAIRABLE_BROWSER_MISSING_TITLE_UNTRACKED_SECONDS,
